...
Get up and running with the pnxt Agent-Native Programming paradigm in under 5 minutes.
...
const llmOutput = { id: 'n1', type: 'observation', label: 'test', inputs: [], output: { type: 'string', value: 'hello' }, securityLabel: { confidentiality: 'public', integrity: 'trusted' } };
...
- [README.md](README.md) — Full project overview and vision
- [status.md](status.md) — Detailed roadmap, sprint history, and repository structure
- [Project Website](https://b2ornot2b.github.io/pnxt/) — Browseable documentation
- [CLAUDE.md](CLAUDE.md) — Contributing guidelines, code style, and git workflow
- [docs/roadmap/paradigm-transition.md](docs/roadmap/paradigm-transition.md) — M1-M5 transition milestones
