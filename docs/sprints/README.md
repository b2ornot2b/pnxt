...
## Phase 8: Operational Maturity (S16-S20)

> **Baseline**: Phase 7 Sprint 15 — Advisory Panel Score 9.5+/10
> **Motivation**: Gap analysis against Weft (WeaveMindAI/weft) — see [`/Users/b2/.claude/plans/begin-the-research-from-hazy-tulip.md`](../../). Phase 8 mines Weft's operational patterns (durable execution, HITL, node breadth, visual authoring) without compromising pnxt's verification foundations (HoTT, IFC, Z3).
> **Milestones**: M5 (Crash-Safe Execution), M6 (Human-in-the-Loop), M7 (First-Class LLM + Catalog Discovery), M8 (Dual Representation), M9 (Type-System Decision Data)

### Research Artifacts

| Artifact | Location |
|----------|----------|
| ADR-001 Durable VPIR Execution | [`docs/decisions/ADR-001-durable-vpir-execution.md`](../decisions/ADR-001-durable-vpir-execution.md) |
| HITL Primitive Design | [`docs/research/hitl-primitive.md`](../research/hitl-primitive.md) |
| Node Catalog Roadmap | [`docs/roadmap/node-catalog.md`](../roadmap/node-catalog.md) |
| Dual Representation Design | [`docs/research/dual-representation.md`](../research/dual-representation.md) |
| Lambda Type-System Position | [`docs/research/lambda-type-system.md`](../research/lambda-type-system.md) |

### Sprint Index

| Sprint | Name | Priority | Primary Advisors | Milestone |
|--------|------|----------|-----------------|-----------|
| [S16](./sprint-16-durable-vpir.md) | Durable VPIR Execution | P1 | Milner, Myers, Agha | **M5 (Crash-Safe Execution)** |
| [S17](./sprint-17-hitl-primitive.md) | Human-in-the-Loop Primitive | P1 | Liskov, Myers, Agha, Pearl | **M6 (Human-in-the-Loop)** |
| [S18](./sprint-18-node-catalog.md) | Node Catalog Expansion — llm-inference + Descriptor Metadata | P1 | Myers, Sutskever, Liskov | **M7 (First-Class LLM + Catalog Discovery)** |
